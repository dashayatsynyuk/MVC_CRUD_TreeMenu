			...
			return {
				"create" : {
                    ...
                    "action": function (data) {
                        ...
                        window.location = $.jstree.defaults.core.createMethod;
					}
				},
				"rename" : {
					"separator_before"	: false,
					...
					*/
					"action"			: function (data) {
						var inst = $.jstree.reference(data.reference),
                            obj = inst.get_node(data.reference);
                        window.location = $.jstree.defaults.core.editMethod + obj.id;
					}
				},
				"remove" : {
					"separator_before"	: false,
                    ...
                    "action": function (data) {
                        if (confirm("Are you sure?")) {
                            ...
                            if (inst.is_selected(obj)) {
                                $.post($.jstree.defaults.core.deleteMethod, { id: obj.id }, function (data) {
